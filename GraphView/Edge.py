...
class Edge(QtGui.QGraphicsItem):
    ...
    def paint(self, painter, option, widget):
        ...
        # if self.ForCommunities:
        #         painter.setPen(QtGui.QPen(self.communtiyColor1 ,self.weight , QtCore.Qt.SolidLine, QtCore.Qt.RoundCap, QtCore.Qt.RoundJoin))
        ...
        #                 pen = QtGui.QPen(QtGui.QPen(QtCore.Qt.darkGray ,1, QtCore.Qt.SolidLine, QtCore.Qt.RoundCap, QtCore.Qt.RoundJoin))
        ...
        #                     pen = QtGui.QPen(QtCore.Qt.darkGreen,1, QtCore.Qt.SolidLine, QtCore.Qt.RoundCap, QtCore.Qt.RoundJoin)
        #                     pen.setWidthF(self.weight)
        #                     painter.setPen(pen)
        #                 else:
        #                     self.EdgeColor.setAlpha(255)
        ...
        #                    pen.setWidthF(self.weight)
        #                 else:
        #                    pen = QtGui.QPen(QtCore.Qt.darkGray, self.weight , QtCore.Qt.SolidLine, QtCore.Qt.RoundCap, QtCore.Qt.RoundJoin)
        #                    pen.setWidthF(self.weight)
        #                 painter.setPen(pen) 
        #                 painter.drawLine(line)
