    ...
    SOMCluster
        ...
        Usage:
            ...
            SOMCluster(datapoints, data_matrix, num_clusters, distance_metric, distance_matrix)
                ...
                vdim            - Vertical node dimension, must be > 1print 
...
class ConsensusCluster(object):
    ...
    def __init__(self, sdata, num_clusters=2, distance_metric='Pearson', subsamples=50, subsample_fraction=None, norm_var=False, 
                 clustering_algs=[KMeansCluster], linkages=['single'], final_alg='PAM', console=None, matrix_thresh=0.0, **kwds):
        ...
        for i in xrange(1, len(local_subsamples) + 1):
            if not MPI_ENABLED:
                ...
                progress('Subsample', i*mpi.size, subsamples)  #Not entirely trcuthful
        ...
        # FIX ME == Disabled consensus matrix and reorder of matrices
        # print np.shape(clustcount_matrices), np.shape(totalcount_matrices)
        self.consensus_matrix = self.gen_consensus_matrix(clustcount_matrices, totalcount_matrices)
        # print "consensus matrix"
        # print self.consensus_matrix
    ...
    def upd_similarity_matrix(self):
        ...
        # print len(datapoints), datapoints[0].cluster_id
    ...
    def reorder_consensus(self):
        ...
        if self.tree is not None:
            ...
            for i in xrange(1, 40000):
                ...
                if not (i % 20) and i < 250:                        #Ramp up temperature
                ...
                if (i - last_best) > 1000:            #No point in going farther than this, usually
                    #print "Breaking at", i
                    break
